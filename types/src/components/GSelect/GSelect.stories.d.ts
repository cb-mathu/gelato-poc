declare const _default: {
    ...
    component: new () => {
        $props: Partial<{
            ...
            id?: string | undefined;
        } & import("./types").NativeSelectProps>;
    };
    argTypes: {
        name: {
            default: string;
...
export declare const DefaultSelect: (props?: any) => JSX.Element;
export declare const SelectWithLabel: (props?: any) => JSX.Element;
export declare const SelectWithLabelAsSlot: () => JSX.Element;
export declare const SelectWithDescription: () => JSX.Element;
export declare const SelectWithDescriptionAsSlot: () => JSX.Element;
export declare const DisabledSelect: () => JSX.Element;
export declare const ReadonlySelect: () => JSX.Element;
export declare const InvalidSelect: () => JSX.Element;
