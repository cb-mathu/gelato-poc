declare const _default: {
    ...
    component: new () => {
        $props: Partial<{
            ...
            "true-value"?: string | number | boolean | undefined;
            "false-value"?: string | number | boolean | undefined;
        } & {
            ...
            id?: string | undefined;
        } & import("./types").NativeButtonProps>;
    };
    argTypes: {
        name: {
            default: string;
...
export declare const CheckboxWithLabel: (props?: Partial<{
    class: string;
    autofocus: boolean;
    disabled: boolean;
    name: string;
    ...
    id?: string | undefined;
} & import("./types").NativeButtonProps> | undefined) => JSX.Element;
export declare const CheckboxWithLabelAsSlot: () => JSX.Element;
export declare const DisabledCheckbox: () => JSX.Element;
export declare const ReadonlyCheckbox: () => JSX.Element;
export declare const InvalidCheckbox: () => JSX.Element;
export declare const CheckboxGroup: (props?: any) => {
    setup(): () => JSX.Element;
};
