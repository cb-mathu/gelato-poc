...
export declare const DefaultSwitch: (props?: Partial<{
    class: string;
    autofocus: boolean;
    disabled: boolean;
    name: string;
...
export declare const DisabledOnSwitch: () => JSX.Element;
export declare const DisabledOffSwitch: () => JSX.Element;
export declare const SwitchWithLabel: (props?: Partial<{
    class: string;
    autofocus: boolean;
    disabled: boolean;
    name: string;
...
export declare const SwitchWithLabelSlot: () => JSX.Element;
export declare const InvalidSwitch: () => JSX.Element;
