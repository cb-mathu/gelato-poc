import { NotificationSize, NotificationVariant } from './types';
declare const _default: {
    ...
    component: new () => {
        $props: Partial<{
            ...
            id?: string | undefined;
        } & import("./types").NativeDivProps>;
    };
    argTypes: {
        size: {
            description: string;
            options: NotificationSize[];
            defaultValue: NotificationSize;
            control: {
                type: string;
            };
        };
...
export declare const DefaultNotification: (props?: Partial<{
    class: string;
    size: NotificationSize;
} & {
    id?: string | undefined;
    ...
    id?: string | undefined;
} & import("./types").NativeDivProps> | undefined) => JSX.Element;
export declare const PrimaryNotification: () => JSX.Element;
export declare const WarningNotification: () => JSX.Element;
export declare const AlertNotification: () => JSX.Element;
export declare const SuccessNotification: () => JSX.Element;
