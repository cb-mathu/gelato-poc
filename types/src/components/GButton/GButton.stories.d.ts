...
export declare const Story: (args: ButtonProps) => {
    setup(): () => JSX.Element;
};
export declare const DefaultButton: (props?: Partial<{
    class: string;
    as: string;
    fluid: boolean;
    loading: boolean;
...
export declare const OutlinedButton: () => JSX.Element;
export declare const LinkButton: (props?: Partial<{
    class: string;
    as: string;
    fluid: boolean;
    loading: boolean;
