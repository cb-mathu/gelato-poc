...
export declare const DefaultRadio: (props?: Partial<{
    class: string;
    autofocus: boolean;
    disabled: boolean;
    name: string;
...
export declare const DisabledRadio: () => JSX.Element;
export declare const ReadonlyRadio: () => JSX.Element;
export declare const InvalidRadio: () => JSX.Element;
export declare const RadioGroup: (props?: any) => {
    setup(): () => JSX.Element;
};
