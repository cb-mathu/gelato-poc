...
export declare const DefaultTag: (props?: Partial<{
    class: string;
} & {
    id?: string | undefined;
    variant?: TagVariant | undefined;
    ...
    id?: string | undefined;
} & import("./types").NativeSpanProps> | undefined) => JSX.Element;
export declare const PrimaryTag: () => JSX.Element;
export declare const SecondaryTag: () => JSX.Element;
export declare const TertiaryTag: () => JSX.Element;
