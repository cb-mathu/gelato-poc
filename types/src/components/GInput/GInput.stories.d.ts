...
declare const _default: {
    ...
    }, () => JSX.Element, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, ("blur" | "update:modelValue")[], "blur" | "update:modelValue", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<{
        class: string;
        type: InputTypes;
        autofocus: boolean;
        disabled: boolean;
...
export declare const DefaultInput: (props?: Partial<Partial<{
    class: string;
    type: InputTypes;
    autofocus: boolean;
    disabled: boolean;
    ...
    id?: string | undefined;
} & import("../core/Input/types").NativeInputProps> & {
    class: string;
    type: InputTypes;
    autofocus: boolean;
    disabled: boolean;
    ...
    description?: string | undefined;
    "onUpdate:modelValue"?: ((value: Event) => void) | undefined;
}> | undefined, slots?: any) => JSX.Element;
export declare const NumberInput: () => JSX.Element;
export declare const InputWithLabel: (props?: any) => JSX.Element;
export declare const InputWithDescription: () => JSX.Element;
export declare const InputWithSlots: any;
export declare const addonImage: () => JSX.Element;
export declare const InputWithPrefix: () => JSX.Element;
export declare const InputWithSuffix: () => JSX.Element;
export declare const InputWithPrefixAndSuffix: () => JSX.Element;
export declare const DisabledInput: any;
export declare const ReadonlyInput: any;
export declare const InvalidInput: any;
export declare const LazyInput: () => {
    setup(): () => JSX.Element;
};
